...
class SocialDataManager {
    constructor(config) {
        ...
        if (config.version === 2) {
            ...
            this._socialEventManagerRead = new eventManagerRead_1.NostrEventManagerRead(nostrCommunicationManagers[0], nostrCachedCommunicationManager);
        }
    ...
    async fetchUserProfiles(pubKeys) {
        ...
        try {
            await utilsManager_1.SocialUtilsManager.exponentialBackoffRetry(fetchData, 5, 1000, 16000, 2);
        }
        catch (error) {
