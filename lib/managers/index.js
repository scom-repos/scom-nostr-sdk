...
class SocialDataManager {
    ...
    async retrieveCommunityPrivateKey(communityInfo, selfPrivateKey) {
        ...
        if (encryptedKey) {
            ...
            communityPrivateKey = await utilsManager_1.SocialUtilsManager.decryptMessage(selfPrivateKey, communityInfo.scpData.gatekeeperPublicKey, communityInfo.scpData.publicKey);
        }
