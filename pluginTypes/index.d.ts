...
declare module "@scom/scom-social-sdk/utils/hashes/_assert.ts" {
    function number(n: number): void;
    function bool(b: boolean): void;
    function bytes(b: Uint8Array | undefined, ...lengths: number[]): void;
    type Hash = {
...
declare module "@scom/scom-social-sdk/utils/hashes/utils.ts" {
    /*! noble-hashes - MIT License (c) 2022 Paul Miller (paulmillr.com) */
    export type TypedArray = Int8Array | Uint8ClampedArray | Uint8Array | Uint16Array | Int16Array | Uint32Array | Int32Array;
    export const createView: (arr: TypedArray) => DataView;
    export const rotr: (word: number, shift: number) => number;
...
/// <amd-module name="@scom/scom-social-sdk/utils/hashes/_sha2.ts" />
declare module "@scom/scom-social-sdk/utils/hashes/_sha2.ts" {
    import { Hash, Input } from "@scom/scom-social-sdk/utils/hashes/utils.ts";
    export abstract class SHA2<T extends SHA2<T>> extends Hash<T> {
        readonly blockLen: number;
        outputLen: number;
        readonly padOffset: number;
...
/// <amd-module name="@scom/scom-social-sdk/utils/hashes/sha256.ts" />
declare module "@scom/scom-social-sdk/utils/hashes/sha256.ts" {
    import { SHA2 } from "@scom/scom-social-sdk/utils/hashes/_sha2.ts";
    class SHA256 extends SHA2<SHA256> {
        A: number;
        B: number;
        C: number;
     ...
     */
    export const sha256: {
        (msg: import("@scom/scom-social-sdk/utils/hashes/utils.ts").Input): Uint8Array;
        outputLen: number;
        blockLen: number;
        create(): import("@scom/scom-social-sdk/utils/hashes/utils.ts").Hash<SHA256>;
    };
    export const sha224: {
        (msg: import("@scom/scom-social-sdk/utils/hashes/utils.ts").Input): Uint8Array;
        outputLen: number;
...
declare module "@scom/scom-social-sdk/utils/curves/abstract/utils.ts" {
    export type Hex = Uint8Array | string;
    export type PrivKey = Hex | bigint;
    export type CHash = {
        (message: Uint8Array | string): Uint8Array;
...
/// <amd-module name="@scom/scom-social-sdk/utils/curves/abstract/modular.ts" />
declare module "@scom/scom-social-sdk/utils/curves/abstract/modular.ts" {
    export function mod(a: bigint, b: bigint): bigint;
    /**
     * Efficiently raise num to power and do modular division.
     * Unsafe in some contexts: uses ladder, so can expose bigint bits.
...
/// <amd-module name="@scom/scom-social-sdk/utils/curves/abstract/curve.ts" />
declare module "@scom/scom-social-sdk/utils/curves/abstract/curve.ts" {
    /*! noble-curves - MIT License (c) 2022 Paul Miller (paulmillr.com) */
    import { IField } from "@scom/scom-social-sdk/utils/curves/abstract/modular.ts";
    export type AffinePoint<T> = {
        x: T;
        y: T;
    } & {
...
/// <amd-module name="@scom/scom-social-sdk/utils/curves/abstract/weierstrass.ts" />
declare module "@scom/scom-social-sdk/utils/curves/abstract/weierstrass.ts" {
    /*! noble-curves - MIT License (c) 2022 Paul Miller (paulmillr.com) */
    import * as mod from "@scom/scom-social-sdk/utils/curves/abstract/modular.ts";
    import * as ut from "@scom/scom-social-sdk/utils/curves/abstract/utils.ts";
    import { CHash, Hex, PrivKey } from "@scom/scom-social-sdk/utils/curves/abstract/utils.ts";
    import { Group, GroupConstructor, BasicCurve, AffinePoint } from "@scom/scom-social-sdk/utils/curves/abstract/curve.ts";
    export type { AffinePoint };
    type HmacFnSync = (key: Uint8Array, ...messages: Uint8Array[]) => Uint8Array;
    type EndomorphismOpts = {
        beta: bigint;
...
/// <amd-module name="@scom/scom-social-sdk/utils/curves/abstract/hash-to-curve.ts" />
declare module "@scom/scom-social-sdk/utils/curves/abstract/hash-to-curve.ts" {
    /*! noble-curves - MIT License (c) 2022 Paul Miller (paulmillr.com) */
    import type { Group, GroupConstructor, AffinePoint } from "@scom/scom-social-sdk/utils/curves/abstract/curve.ts";
    import { IField } from "@scom/scom-social-sdk/utils/curves/abstract/modular.ts";
    import { CHash } from "@scom/scom-social-sdk/utils/curves/abstract/utils.ts";
    /**
     * * `DST` is a domain separation tag, defined in section 2.2.5
     * * `p` characteristic of F, where F is a finite field of characteristic p and order q = p^m
     * * `m` is extension degree (1 for prime fields)
...
/// <amd-module name="@scom/scom-social-sdk/utils/hashes/hmac.ts" />
declare module "@scom/scom-social-sdk/utils/hashes/hmac.ts" {
    import { Hash, CHash, Input } from "@scom/scom-social-sdk/utils/hashes/utils.ts";
    export class HMAC<T extends Hash<T>> extends Hash<HMAC<T>> {
        oHash: T;
        iHash: T;
        blockLen: number;
...
/// <amd-module name="@scom/scom-social-sdk/utils/curves/_shortw_utils.ts" />
declare module "@scom/scom-social-sdk/utils/curves/_shortw_utils.ts" {
    import { randomBytes } from "@scom/scom-social-sdk/utils/hashes/utils.ts";
    import { CurveType } from "@scom/scom-social-sdk/utils/curves/abstract/weierstrass.ts";
    import { CHash } from "@scom/scom-social-sdk/utils/curves/abstract/utils.ts";
    export function getHash(hash: CHash): {
        hash: CHash;
        hmac: (key: Uint8Array, ...msgs: Uint8Array[]) => Uint8Array;
    ...
    type CurveDef = Readonly<Omit<CurveType, 'hash' | 'hmac' | 'randomBytes'>>;
    export function createCurve(curveDef: CurveDef, defHash: CHash): Readonly<{
        create: (hash: CHash) => import("@scom/scom-social-sdk/utils/curves/abstract/weierstrass.ts").CurveFn;
        CURVE: Readonly<{
            readonly nBitLength: number;
            readonly nByteLength: number;
            readonly Fp: import("@scom/scom-social-sdk/utils/curves/abstract/modular.ts").IField<bigint>;
            readonly n: bigint;
            readonly h: bigint;
            readonly hEff?: bigint;
            readonly Gx: bigint;
            ...
            readonly isTorsionFree?: (c: import("@scom/scom-social-sdk/utils/curves/abstract/weierstrass.ts").ProjConstructor<bigint>, point: import("@scom/scom-social-sdk/utils/curves/abstract/weierstrass.ts").ProjPointType<bigint>) => boolean;
            readonly clearCofactor?: (c: import("@scom/scom-social-sdk/utils/curves/abstract/weierstrass.ts").ProjConstructor<bigint>, point: import("@scom/scom-social-sdk/utils/curves/abstract/weierstrass.ts").ProjPointType<bigint>) => import("@scom/scom-social-sdk/utils/curves/abstract/weierstrass.ts").ProjPointType<bigint>;
            readonly hash: CHash;
            readonly hmac: (key: Uint8Array, ...messages: Uint8Array[]) => Uint8Array;
            readonly randomBytes: (bytesLength?: number) => Uint8Array;
            lowS: boolean;
        ...
        getPublicKey: (privateKey: import("@scom/scom-social-sdk/utils/curves/abstract/utils.ts").PrivKey, isCompressed?: boolean) => Uint8Array;
        getSharedSecret: (privateA: import("@scom/scom-social-sdk/utils/curves/abstract/utils.ts").PrivKey, publicB: import("@scom/scom-social-sdk/utils/curves/abstract/utils.ts").Hex, isCompressed?: boolean) => Uint8Array;
        sign: (msgHash: import("@scom/scom-social-sdk/utils/curves/abstract/utils.ts").Hex, privKey: import("@scom/scom-social-sdk/utils/curves/abstract/utils.ts").PrivKey, opts?: import("@scom/scom-social-sdk/utils/curves/abstract/weierstrass.ts").SignOpts) => import("@scom/scom-social-sdk/utils/curves/abstract/weierstrass.ts").RecoveredSignatureType;
        verify: (signature: import("@scom/scom-social-sdk/utils/curves/abstract/utils.ts").Hex | {
            r: bigint;
            s: bigint;
        }, msgHash: import("@scom/scom-social-sdk/utils/curves/abstract/utils.ts").Hex, publicKey: import("@scom/scom-social-sdk/utils/curves/abstract/utils.ts").Hex, opts?: import("@scom/scom-social-sdk/utils/curves/abstract/weierstrass.ts").VerOpts) => boolean;
        ProjectivePoint: import("@scom/scom-social-sdk/utils/curves/abstract/weierstrass.ts").ProjConstructor<bigint>;
        Signature: import("@scom/scom-social-sdk/utils/curves/abstract/weierstrass.ts").SignatureConstructor;
        utils: {
            normPrivateKeyToScalar: (key: import("@scom/scom-social-sdk/utils/curves/abstract/utils.ts").PrivKey) => bigint;
            isValidPrivateKey(privateKey: import("@scom/scom-social-sdk/utils/curves/abstract/utils.ts").PrivKey): boolean;
            randomPrivateKey: () => Uint8Array;
            precompute: (windowSize?: number, point?: import("@scom/scom-social-sdk/utils/curves/abstract/weierstrass.ts").ProjPointType<bigint>) => import("@scom/scom-social-sdk/utils/curves/abstract/weierstrass.ts").ProjPointType<bigint>;
        };
    }>;
}
/// <amd-module name="@scom/scom-social-sdk/utils/curves/secp256k1.ts" />
declare module "@scom/scom-social-sdk/utils/curves/secp256k1.ts" {
    import { mod } from "@scom/scom-social-sdk/utils/curves/abstract/modular.ts";
    import { ProjPointType as PointType } from "@scom/scom-social-sdk/utils/curves/abstract/weierstrass.ts";
    import type { Hex, PrivKey } from "@scom/scom-social-sdk/utils/curves/abstract/utils.ts";
    import { bytesToNumberBE, numberToBytesBE } from "@scom/scom-social-sdk/utils/curves/abstract/utils.ts";
    export const secp256k1: Readonly<{
        create: (hash: import("@scom/scom-social-sdk/utils/curves/abstract/utils.ts").CHash) => import("@scom/scom-social-sdk/utils/curves/abstract/weierstrass.ts").CurveFn;
        CURVE: Readonly<{
            readonly nBitLength: number;
            readonly nByteLength: number;
            readonly Fp: import("@scom/scom-social-sdk/utils/curves/abstract/modular.ts").IField<bigint>;
            ...
            readonly isTorsionFree?: (c: import("@scom/scom-social-sdk/utils/curves/abstract/weierstrass.ts").ProjConstructor<bigint>, point: PointType<bigint>) => boolean;
            readonly clearCofactor?: (c: import("@scom/scom-social-sdk/utils/curves/abstract/weierstrass.ts").ProjConstructor<bigint>, point: PointType<bigint>) => PointType<bigint>;
            readonly hash: import("@scom/scom-social-sdk/utils/curves/abstract/utils.ts").CHash;
            readonly hmac: (key: Uint8Array, ...messages: Uint8Array[]) => Uint8Array;
            readonly randomBytes: (bytesLength?: number) => Uint8Array;
            lowS: boolean;
            readonly bits2int?: (bytes: Uint8Array) => bigint;
        ...
        getPublicKey: (privateKey: PrivKey, isCompressed?: boolean) => Uint8Array;
        getSharedSecret: (privateA: PrivKey, publicB: Hex, isCompressed?: boolean) => Uint8Array;
        sign: (msgHash: Hex, privKey: PrivKey, opts?: import("@scom/scom-social-sdk/utils/curves/abstract/weierstrass.ts").SignOpts) => import("@scom/scom-social-sdk/utils/curves/abstract/weierstrass.ts").RecoveredSignatureType;
        verify: (signature: Hex | {
            r: bigint;
            s: bigint;
        }, msgHash: Hex, publicKey: Hex, opts?: import("@scom/scom-social-sdk/utils/curves/abstract/weierstrass.ts").VerOpts) => boolean;
        ProjectivePoint: import("@scom/scom-social-sdk/utils/curves/abstract/weierstrass.ts").ProjConstructor<bigint>;
        Signature: import("@scom/scom-social-sdk/utils/curves/abstract/weierstrass.ts").SignatureConstructor;
        utils: {
            normPrivateKeyToScalar: (key: PrivKey) => bigint;
    ...
    export const hashToCurve: (msg: Uint8Array, options?: import("@scom/scom-social-sdk/utils/curves/abstract/hash-to-curve.ts").htfBasicOpts) => import("@scom/scom-social-sdk/utils/curves/abstract/hash-to-curve.ts").H2CPoint<bigint>;
    export const encodeToCurve: (msg: Uint8Array, options?: import("@scom/scom-social-sdk/utils/curves/abstract/hash-to-curve.ts").htfBasicOpts) => import("@scom/scom-social-sdk/utils/curves/abstract/hash-to-curve.ts").H2CPoint<bigint>;
    export function schnorrGetExtPubKeyY(priv: PrivKey): Uint8Array;
}
/// <amd-module name="@scom/scom-social-sdk/utils/keys.ts" />
declare module "@scom/scom-social-sdk/utils/keys.ts" {
    export function generatePrivateKey(): string;
    export function getPublicKey(privateKey: string): string;
    export function getPublicKeyY(privateKey: string): string;
    export function getSharedSecret(privateKey: string, publicKey: string): string;
...
/// <amd-module name="@scom/scom-social-sdk/utils/crypto.ts" />
declare module "@scom/scom-social-sdk/utils/crypto.ts" {
    export function hexStringToUint8Array(hexString: string): Uint8Array;
    export function encryptSharedMessage(ourPrivateKey: string, theirPublicKey: string, text: string): Promise<string>;
    export function decryptSharedMessage(ourPrivateKey: string, theirPublicKey: string, encryptedData: string): Promise<string>;
    export function encryptWithPubKey(publicKey: string, text: string): Promise<string>;
    export function decryptWithPrivKey(privateKey: string, encryptedData: string): Promise<string>;
}
...
declare module "@scom/scom-social-sdk/utils/index.ts" {
    ...
    export { encryptSharedMessage, encryptWithPubKey, hexStringToUint8Array, decryptSharedMessage, decryptWithPrivKey } from "@scom/scom-social-sdk/utils/crypto.ts";
}
...
declare module "@scom/scom-social-sdk/managers/eventManagerRead.ts" {
    ...
    import { IAllUserRelatedChannels, IChannelInfo, ICommunityBasicInfo, ICommunityInfo, INostrEvent, IPaymentActivity } from "@scom/scom-social-sdk/utils/interfaces.ts";
