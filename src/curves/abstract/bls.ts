...
import * as htf from './hash-to-curve';
import {
  CurvePointsType,
...
import { H2CPointConstructor, MapToCurve, Opts } from './hash-to-curve';
...
class Wrapper<T> {
  createHasher = (a,b,c) => htf.createHasher<T>(a,b,c);
}
...
export type CurveFn<Fp, Fp2, Fp6, Fp12> = {
  ...
  G1: CurvePointsRes<Fp> & ReturnType<Wrapper<Fp>['createHasher']>; // ReturnType<typeof htf.createHasher<Fp>>;
  G2: CurvePointsRes<Fp2> & ReturnType<Wrapper<Fp2>['createHasher']>; // ReturnType<typeof htf.createHasher<Fp2>>
  Signature: SignatureCoder<Fp2>;
