...
define("@scom/scom-social-sdk/utils/managers.ts", ["require", "exports", "@ijstech/eth-wallet", "@scom/scom-social-sdk/core/index.ts", "@scom/scom-social-sdk/utils/interfaces.ts", "@scom/scom-social-sdk/utils/geohash.ts"], function (require, exports, eth_wallet_1, index_1, interfaces_1, geohash_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class NostrEventManager {
        ...
        async fetchProfileFeedCacheEvents(pubKey, since = 0) {
            const decodedPubKey = pubKey.startsWith('npub1') ? index_1.Nip19.decode(pubKey).data : pubKey;
            let msg = {
                limit: 20,
                notes: "authored",
        ...
        async fetchProfileRepliesCacheEvents(pubKey, since = 0) {
            const decodedPubKey = pubKey.startsWith('npub1') ? index_1.Nip19.decode(pubKey).data : pubKey;
            let msg = {
                limit: 20,
                notes: "replies",
        ...
        async fetchHomeFeedCacheEvents(pubKey, since = 0) {
            let msg = {
                limit: 20,
                since
            };
