...
define("@scom/scom-social-sdk/utils/geoquery.ts", ["require", "exports", "@scom/scom-social-sdk/utils/geohash.ts"], function (require, exports, geohash_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    const rangeIndex = [
        0.6,
...
define("@scom/scom-social-sdk/utils/managers.ts", ["require", "exports", "@ijstech/eth-wallet", "@scom/scom-social-sdk/core/index.ts", "@scom/scom-social-sdk/utils/interfaces.ts", "@scom/scom-social-sdk/utils/geohash.ts", "@scom/scom-social-sdk/utils/mqtt.ts", "@scom/scom-social-sdk/utils/lightningWallet.ts"], function (require, exports, eth_wallet_1, index_2, interfaces_1, geohash_2, mqtt_1, lightningWallet_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class NostrEventManagerRead {
        ...
        async fetchThreadCacheEvents(id, pubKey) {
            let decodedId = id.startsWith('note1') ? index_2.Nip19.decode(id).data : id;
            let msg = {
                event_id: decodedId,
                limit: 100
            };
            if (pubKey) {
                const decodedPubKey = pubKey.startsWith('npub1') ? index_2.Nip19.decode(pubKey).data : pubKey;
        ...
        async fetchHomeFeedCacheEvents(pubKey, since = 0, until = 0) {
            ...
            msg.pubkey = index_2.Nip19.decode('npub1nfgqmnxqsjsnsvc2r5djhcx4ap3egcjryhf9ppxnajskfel2dx9qq6mnsp').data; //FIXME: Account to show Nostr highlights 
            if (pubKey) {
                const decodedPubKey = pubKey.startsWith('npub1') ? index_2.Nip19.decode(pubKey).data : pubKey;
                msg.user_pubkey = decodedPubKey;
            }
        ...
        async fetchUserProfileCacheEvents(pubKeys) {
            const decodedPubKeys = pubKeys.map(pubKey => pubKey.startsWith('npub1') ? index_2.Nip19.decode(pubKey).data : pubKey);
            let msg = {
        ...
        async fetchUserBookmarkedCommunities(pubKey, excludedCommunity) {
            ...
            const communities = SocialUtilsManager.extractBookmarkedCommunities(bookmarkedCommunitiesEvent, excludedCommunity);
            return communities;
        }
        async fetchCommunity(creatorId, communityId) {
            const decodedCreatorId = creatorId.startsWith('npub1') ? index_2.Nip19.decode(creatorId).data : creatorId;
            let infoMsg = {
                kinds: [34550],
        ...
        async fetchChannelMessages(channelId, since = 0, until = 0) {
            const decodedChannelId = channelId.startsWith('npub1') ? index_2.Nip19.decode(channelId).data : channelId;
            let messagesReq = {
                kinds: [42],
                "#e": [decodedChannelId],
                limit: 20
        ...
        async resetMessageCount(pubKey, sender, privateKey) {
            ...
            event.id = index_2.Event.getEventHash(event);
            event.sig = index_2.Event.getSignature(event, privateKey);
            const msg = {
    ...
    class NostrEventManagerReadV2 extends NostrEventManagerRead {
        ...
        async fetchCommunitiesGeneralMembers(communities) {
            ...
            for (let community of communities) {
                const decodedCreatorId = community.creatorId.startsWith('npub1') ? index_2.Nip19.decode(community.creatorId).data : community.creatorId;
                let request = {
                    pubkey: decodedCreatorId,
    ...
    class SocialDataManager {
        ...
        async fetchProfileFeedInfo(pubKey, since = 0, until) {
            ...
            for (let note of notes) {
                if (note.eventData.tags?.length) {
                    ...
                    if (communityUri) {
                        ...
                        note.community = {
                            communityUri,
                            communityId,
                            creatorId: index_2.Nip19.npubEncode(creatorId)
                        };
                    }
                }
                ...
                const encodedPubkey = index_2.Nip19.npubEncode(metadata.pubkey);
        ...
        async fetchThreadNotesInfo(focusedNoteId) {
            ...
            let decodedFocusedNoteId = focusedNoteId.startsWith('note1') ? index_2.Nip19.decode(focusedNoteId).data : focusedNoteId;
        ...
        async followUser(userPubKey) {
            const decodedUserPubKey = userPubKey.startsWith('npub1') ? index_2.Nip19.decode(userPubKey).data : userPubKey;
        ...
        async generateGroupKeys(privateKey, encryptionPublicKeys) {
            const groupPrivateKey = index_2.Keys.generatePrivateKey();
            const groupPublicKey = index_2.Keys.getPublicKey(groupPrivateKey);
        ...
        async createCommunity(newInfo, creatorId) {
            ...
            if (communityInfo.membershipType === interfaces_1.MembershipType.NFTExclusive) {
                const gatekeeperPublicKey = index_2.Nip19.decode(communityInfo.gatekeeperNpub).data;
                ...
                for (let memberId of communityInfo.memberIds) {
                    const memberPublicKey = index_2.Nip19.decode(memberId).data;
        ...
        async updateCommunity(info) {
            if (info.membershipType === interfaces_1.MembershipType.NFTExclusive) {
                const gatekeeperPublicKey = index_2.Nip19.decode(info.gatekeeperNpub).data;
        ...
        async encryptGroupMessage(privateKey, groupPublicKey, message) {
            const messagePrivateKey = index_2.Keys.generatePrivateKey();
            const messagePublicKey = index_2.Keys.getPublicKey(messagePrivateKey);
        ...
        async fetchDirectMessagesBySender(selfPubKey, senderPubKey, since, until) {
            const decodedSenderPubKey = index_2.Nip19.decode(senderPubKey).data;
        ...
        async sendDirectMessage(chatId, message) {
            const decodedReceiverPubKey = index_2.Nip19.decode(chatId).data;
        ...
        async fetchMessageContacts(pubKey) {
            ...
            let profiles = Object.entries(metadataByPubKeyMap).map(([k, v]) => {
                const encodedPubkey = index_2.Nip19.npubEncode(k);
                return {
                    id: encodedPubkey,
                    pubKey: k,
            ...
            for (let channel of channels) {
                let creatorId = index_2.Nip19.npubEncode(channel.eventData.pubkey);
                profiles.push({
                    id: channel.id,
            ...
            for (let event of generalMembersEvents) {
                ...
                for (let communityUri of communityUriArr) {
                    if (!communityUriToMemberIdRoleComboMap[communityUri])
                        continue;
                    const pubkey = index_2.Nip19.npubEncode(event.pubkey);
        ...
        extractCalendarEventInfo(event) {
            ...
            if (geohash) {
                lonlat = geohash_2.default.decode(geohash);
            }
            const image = event.tags.find(tag => tag[0] === 'image')?.[1];
            let type;
            let startTime;
            ...
            const naddr = index_2.Nip19.naddrEncode({
                identifier: id,
                pubkey: event.pubkey,
                kind: event.kind,
                relays: []
        ...
        async updateCalendarEvent(updateCalendarEventInfo) {
            ...
            if (response.success) {
                ...
                naddr = index_2.Nip19.naddrEncode({
        ...
        async retrieveCalendarEvent(naddr) {
            let address = index_2.Nip19.decode(naddr).data;
        ...
        async sendPingRequest(pubkey, walletAddress, signature) {
            if (!this._defaultRestAPIRelay)
                return null;
            let msg = pubkey;
            const pubkeyY = index_2.Keys.getPublicKeyY(this._privateKey);
            const data = {
                msg: msg,
                signature: signature,
                pubkey: pubkey,
...
define("@scom/scom-social-sdk/utils/index.ts", ["require", "exports", "@scom/scom-social-sdk/utils/interfaces.ts", "@scom/scom-social-sdk/utils/managers.ts", "@scom/scom-social-sdk/utils/mqtt.ts"], function (require, exports, interfaces_2, managers_1, mqtt_2) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    Object.defineProperty(exports, "MqttManager", { enumerable: true, get: function () { return mqtt_2.MqttManager; } });
});
define("@scom/scom-social-sdk", ["require", "exports", "@scom/scom-social-sdk/core/index.ts", "@scom/scom-social-sdk/utils/index.ts"], function (require, exports, index_3, index_4) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.MqttManager = exports.NostrRestAPIManager = exports.NostrWebSocketManager = exports.SocialDataManager = exports.SocialUtilsManager = exports.NostrEventManagerWrite = exports.NostrEventManagerReadV2 = exports.NostrEventManagerRead = exports.CalendarEventType = exports.CommunityRole = exports.MembershipType = exports.Bech32 = exports.Nip19 = exports.Keys = exports.Event = void 0;
    Object.defineProperty(exports, "Event", { enumerable: true, get: function () { return index_3.Event; } });
    Object.defineProperty(exports, "Keys", { enumerable: true, get: function () { return index_3.Keys; } });
    Object.defineProperty(exports, "Nip19", { enumerable: true, get: function () { return index_3.Nip19; } });
    Object.defineProperty(exports, "Bech32", { enumerable: true, get: function () { return index_3.Bech32; } });
    Object.defineProperty(exports, "MembershipType", { enumerable: true, get: function () { return index_4.MembershipType; } });
    Object.defineProperty(exports, "CommunityRole", { enumerable: true, get: function () { return index_4.CommunityRole; } });
    Object.defineProperty(exports, "CalendarEventType", { enumerable: true, get: function () { return index_4.CalendarEventType; } });
    Object.defineProperty(exports, "NostrEventManagerRead", { enumerable: true, get: function () { return index_4.NostrEventManagerRead; } });
    Object.defineProperty(exports, "NostrEventManagerReadV2", { enumerable: true, get: function () { return index_4.NostrEventManagerReadV2; } });
    Object.defineProperty(exports, "NostrEventManagerWrite", { enumerable: true, get: function () { return index_4.NostrEventManagerWrite; } });
    Object.defineProperty(exports, "SocialUtilsManager", { enumerable: true, get: function () { return index_4.SocialUtilsManager; } });
    Object.defineProperty(exports, "SocialDataManager", { enumerable: true, get: function () { return index_4.SocialDataManager; } });
    Object.defineProperty(exports, "NostrWebSocketManager", { enumerable: true, get: function () { return index_4.NostrWebSocketManager; } });
    Object.defineProperty(exports, "NostrRestAPIManager", { enumerable: true, get: function () { return index_4.NostrRestAPIManager; } });
    Object.defineProperty(exports, "MqttManager", { enumerable: true, get: function () { return index_4.MqttManager; } });
});
